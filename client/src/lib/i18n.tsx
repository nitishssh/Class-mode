...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "classroom.connecting": "Connecting to ClassMode Learning Engine",
    "classroom.studyArena": "ClassMode Learning",
    ...
    "live.title": "ClassMode Live",
    "chat.tutorTitle": "ClassMode Tutor • ",
