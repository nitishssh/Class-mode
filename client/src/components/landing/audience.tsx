    ...
    <section className="overflow-hidden">
      <div className="grid lg:grid-cols-2">
        ...
        >
          ...
          <Button
            variant="outline"
            className="group w-fit gap-2 rounded-full border-white/20 px-7 font-semibold text-white hover:border-white/40 hover:bg-white/10"
            size="lg"
      ...
      <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
        {steps.map((step, i) => (
          ...
          >
            ...
            <div className={`mb-5 flex h-12 w-12 items-center justify-center rounded-xl ${step.color}`}>
