    ...
    <div className="container">
      ...
      >
        ...
        <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
          ClassMode was built inside a real school — teachers with thirty students and four periods,
          an office with one register. It runs on the phones your staff already carry. No server
          room, no consultant, no training day.
        </p>
      </motion.div>
