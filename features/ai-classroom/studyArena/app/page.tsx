...
function HomePage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (savedLanguage === 'en-US' || savedLanguage === 'en-US') {
        ...
        const detected = navigator.language?.startsWith('zh') ? 'en-US' : 'en-US';
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,rgba(109,40,217,0.08),transparent)] dark:bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,rgba(124,58,237,0.12),transparent)] bg-background flex flex-col items-center p-4 pt-16 md:p-8 md:pt-16 overflow-x-hidden">
      {/* ═══ Top-right pill (unchanged) ═══ */}
      <div
        ref={toolbarRef}
        className="fixed top-4 right-4 z-50 flex items-center gap-1 bg-white/70 dark:bg-white/[0.05] backdrop-blur-xl px-2 py-1.5 rounded-full border border-border/40 shadow-sm"
      >
        {/* Language Selector */}
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-violet-500/[0.06] dark:bg-violet-400/[0.07] rounded-full blur-3xl" />
        <div className="absolute top-[30%] left-[10%] w-64 h-64 bg-indigo-400/[0.05] rounded-full blur-2xl" />
        <div className="absolute top-[20%] right-[8%] w-48 h-48 bg-purple-400/[0.05] rounded-full blur-2xl" />
      </div>
      ...
      >
        ...
        >
          ...
          <span className="text-2xl font-bold tracking-tight bg-gradient-to-r from-violet-700 to-indigo-600 dark:from-violet-400 dark:to-indigo-400 bg-clip-text text-transparent">
            Friday Learning
          </span>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-[13px] font-medium tracking-wide text-muted-foreground/50 mb-8 uppercase"
        >
          {t('home.slogan')}
        </motion.p>
        ...
        <motion.div
          ...
          className="w-full"
        >
          <div className="w-full rounded-2xl border border-border/50 bg-white/90 dark:bg-white/[0.04] backdrop-blur-2xl shadow-[0_2px_24px_rgba(0,0,0,0.06)] dark:shadow-[0_2px_24px_rgba(0,0,0,0.3)] transition-shadow focus-within:shadow-[0_4px_32px_rgba(109,40,217,0.12)] dark:focus-within:shadow-[0_4px_32px_rgba(124,58,237,0.18)] focus-within:border-violet-300/60 dark:focus-within:border-violet-500/30">
            ...
            <textarea
              ...
              className="w-full resize-none border-0 bg-transparent px-4 pt-1 pb-2 text-[14px] leading-relaxed placeholder:text-muted-foreground/35 focus:outline-none min-h-[140px] max-h-[300px] font-[450]"
            ...
            <div className="px-3 pb-3 flex items-end gap-2">
              ...
              <button
                ...
                className={cn(
                  ...
                  canGenerate
                    ? 'bg-gradient-to-br from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white shadow-md shadow-violet-500/25 cursor-pointer'
      ...
      {classrooms.length > 0 && (
        ...
        >
          ...
          >
            <div className="flex-1 h-px bg-border/30 group-hover:bg-violet-300/40 dark:group-hover:bg-violet-500/20 transition-colors" />
            <span className="shrink-0 flex items-center gap-2 text-[11px] font-semibold tracking-widest uppercase text-muted-foreground/40 group-hover:text-violet-500/70 dark:group-hover:text-violet-400/60 transition-colors select-none">
              <Clock className="size-3" />
              {t('classroom.recentClassrooms')}
              <span className="tabular-nums opacity-70">{classrooms.length}</span>
              <motion.div
      ...
      <div className="mt-auto pt-12 pb-4 text-center text-[11px] font-medium tracking-widest uppercase text-muted-foreground/25">
        Friday Learning · Built for you, by you
      </div>
    </div>
  );
}
