    ...
    <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Briefly describe the purpose and content of this scene"
                  rows={2}
                  disabled={isLoading}
                />
              </div>
      ...
      {outlines.length === 0 && (
        <Card className="p-8 text-center">
          <p className="text-muted-foreground mb-4">Scene Outlines</p>
          <Button variant="outline" onClick={addOutline} disabled={isLoading}>
            <Plus className="size-4 mr-1" />
      ...
      <div className="flex justify-between pt-4">
        ...
        <Button onClick={onConfirm} disabled={isLoading || outlines.length === 0}>
          {isLoading ? 'Generating...' : 'Confirm & Generate Course'}
        </Button>
      </div>
    </div>
  );
