...
export const generationEnUS = {
  classroom: {
    recentClassrooms: 'Recent Sessions',
    today: 'Today',
    yesterday: 'Yesterday',
    daysAgo: 'days ago',
    slides: 'slides',
  ...
  upload: {
    ...
    generateFailed: 'Failed to generate session, please try again',
    requirementPlaceholder:
      'What do you want to learn today?\n"Teach me Python from scratch in 30 minutes"\n"Explain Fourier Transform on the whiteboard"\n"How to play the board game Avalon"',
    requirementRequired: 'Please enter what you want to learn',
  ...
  generation: {
    ...
    firstPageReady: 'First page ready! Opening your session...',
    speechFailed: 'Speech generation failed',
    retryScene: 'Retry',
    retryingScene: 'Regenerating...',
    backToHome: 'Back to Home',
    sessionNotFound: 'Session Not Found',
    sessionNotFoundDesc: 'Please enter what you want to learn to start.',
    goBackAndRetry: 'Go Back and Retry',
    classroomReady: 'Your personalized learning session is ready.',
    aiWorking: 'AI Tutor Working...',
    ...
    // Agent generation
    agentGeneration: 'Setting Up Your Learning Team',
    agentGenerationDesc: 'Personalizing AI tutors for your topic...',
    agentRevealTitle: 'Your Learning Team',
    viewAgents: 'Meet Your Tutors',
    continue: 'Continue',
    // Outline errors
