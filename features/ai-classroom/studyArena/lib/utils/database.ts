...
const DATABASE_NAME = 'FridayLearning-Database';
const _DATABASE_VERSION = 8;

/**
 * FridayLearning Database Instance
 */
class FridayLearningDatabase extends Dexie {
  // Table definitions
...
export const db = new FridayLearningDatabase();
