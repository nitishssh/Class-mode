...
**Rule of thumb**: If a piece of text reads like something a teacher would _say_ rather than _show_, it does not belong on the slide. Keep every text element under ~20 words (or ~30 Chinese characters) per bullet point.
