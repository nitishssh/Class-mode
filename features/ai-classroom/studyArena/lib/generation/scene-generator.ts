  ...
  return [
    {
      ...
      text: "Let's start a project-based learning activity. Choose your role, check the task board, and begin collaborating.",
    },
  ];
}
  ...
  return [
    {
      ...
      text: "Let's take a quick quiz to check your understanding.",
    },
  ];
}
  ...
  return [
    {
      ...
      text: "Let's explore this concept through interactive visualization. Try interacting with the elements on the page and observe the changes.",
    },
  ];
}
