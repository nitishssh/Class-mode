...
- **₹20 per student per month**, billed monthly on enrolled students in the app.
- **Term: 3 months** (one school term). First 2 weeks are setup and training — **unbilled**; billing starts when attendance is actually being marked.
- Either side may end the pilot with 2 weeks' written notice. Your data is exported to you (Excel) at no cost, whatever the outcome.
- **What we ask:** teachers mark attendance daily (under a minute per class; we train them) · one named contact in the office · a short principal feedback chat every two weeks.
